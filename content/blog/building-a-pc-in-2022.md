...
[Framework](https://frame.work) makes a DIY Laptop kit with modern power and capabilities in an incredible 13 inch thin and light form factor.  
...
Thankfully, there's a great community of Framework customers who are active on [the official forums](https://community.frame.work), Reddit, Discord, and even IRC. This is a great resource for everything from ["waiting therapy"](https://community.frame.work/t/batch-2-intel-12th-guild/19490/427) to technical support. 
...
{% <caption_row> %}
{% <caption_image src="/images/fwbox1.jpg" alt="a photo of the Framework Laptop shipping box" style="container-left"> %}Laptop{% </caption_image> %}
{% <caption_image src="/images/fwbox2.jpg" alt="a photo of the second layer of the Framework Laptop shipping box" style="container-right"> %}Components{% </caption_image> %}
{% </caption_row> %}
...
{% <caption_group> %}
{% <caption_image src="/images/fwunboxed.jpg" alt="" style="container-right"> %}Framework Components{% </caption_image> %}
...
{% <caption_group> %}
{% <caption_image src="/images/fwopen.jpg" alt="" style="container-left"> %}Keyboard removed{% </caption_image> %}
...
{% <caption_group> %}
{% <caption_image src="/images/fwinstall.jpg" alt="" style="container-right"> %}Installing NVMe drive{% </caption_image> %}
...
{% <caption_row> %}
{% <caption_image src="/images/fwcards.jpg" alt="a photo showing installation of Framework Laptop expansion cards" style="container-left"> %}Expansion card{% </caption_image> %}
{% <caption_image src="/images/fwboot.jpg" alt="a photo of the framework boot screen" style="container-right"> %}First boot!{% </caption_image> %}
{% </caption_row> %}
